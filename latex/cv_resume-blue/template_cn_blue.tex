...
\section{学术成果}
\cvline{已发表}{Lin D, Wang Q. Physics-informed hybrid neural network for offshore wind speed prediction under nonlinear turbulence conditions. \textit{Renewable Energy}, 2026. （SCI Q2, IF=8.1）}
\cvline{Under Review}{Deep contrastive learning framework for multi-site renewable energy forecasting under distribution shift. \textit{IEEE Transactions on Sustainable Energy}.}
